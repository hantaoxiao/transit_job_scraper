(function () {
  ...
  const agencyMeta = {
    "AC Transit": { short: "AC", name: "AC Transit", color: "#0f6b50", location: "Oakland, CA", logo: "assets/agency-logos/ac-transit.svg" },
    "Access Services": { short: "AS", name: "Access Services", color: "#005eb8", location: "El Monte, CA", logo: "assets/agency-logos/access-services.png" },
    "Antelope Valley Transit Authority": { short: "AVTA", name: "Antelope Valley Transit Authority", color: "#005eb8", location: "Lancaster, CA", logo: "assets/agency-logos/antelope-valley-transit-authority.png" },
    "BART": { short: "BART", name: "Bay Area Rapid Transit", color: "#0074bc", location: "Oakland, CA", logo: "assets/agency-logos/bart.svg" },
    "Big Blue Bus": { short: "BBB", name: "Big Blue Bus", color: "#005eb8", location: "Santa Monica, CA", logo: "assets/agency-logos/big-blue-bus.svg" },
    "Broward County Transit": { short: "BCT", name: "Broward County Transit", color: "#005eb8", location: "Fort Lauderdale, FL", logo: "assets/agency-logos/broward-county-transit.svg" },
    ...
    "CATS": { short: "CATS", name: "Charlotte Area Transit System", color: "#1b5aa6", location: "Charlotte, NC", logo: "assets/agency-logos/cats-blue.png" },
    ...
    "CTA": { short: "CTA", name: "Chicago Transit Authority", color: "#c62828", location: "Chicago, IL", logo: "assets/agency-logos/cta.svg" },
    "CapMetro": { short: "CapMetro", name: "CapMetro", color: "#d71920", location: "Austin, TX", logo: "assets/agency-logos/capmetro.svg" },
    "DART": { short: "DART", name: "Dallas Area Rapid Transit", color: "#f6c600", location: "Dallas, TX", logo: "assets/agency-logos/dart.png" },
    "DDOT": { short: "DDOT", name: "Detroit Department of Transportation", color: "#005baa", location: "Detroit, MI", logo: "assets/agency-logos/ddot.svg" },
    ...
    "GRTC": { short: "GRTC", name: "Greater Richmond Transit Company", color: "#005baa", location: "Richmond, VA", logo: "assets/agency-logos/grtc-official.png" },
    "Gold Coast Transit District": { short: "GCTD", name: "Gold Coast Transit District", color: "#005eb8", location: "Oxnard, CA", logo: "assets/agency-logos/gold-coast-transit-district.jpg" },
    "Golden Empire Transit District": { short: "GET", name: "Golden Empire Transit District", color: "#005eb8", location: "Bakersfield, CA", logo: "assets/agency-logos/golden-empire-transit-district.png" },
    "Golden Gate Transit": { short: "GGT", name: "Golden Gate Bridge, Highway and Transportation District", color: "#f6c600", location: "San Francisco, CA", logo: "assets/agency-logos/golden-gate-transit.jpg" },
    ...
    "Honolulu DTS": { short: "DTS", name: "Honolulu Department of Transportation Services", color: "#007a7a", location: "Honolulu, HI", logo: "assets/agency-logos/honolulu-dts.svg" },
    ...
    "IndyGo": { short: "IndyGo", name: "IndyGo", color: "#6f2c91", location: "Indianapolis, IN", logo: "assets/agency-logos/indygo.svg" },
    "Intercity Transit": { short: "IT", name: "Intercity Transit", color: "#005eb8", location: "Olympia, WA", logo: "assets/agency-logos/intercity-transit.svg" },
    "KCATA": { short: "RideKC", name: "Kansas City Area Transportation Authority", color: "#0072ce", location: "Kansas City, MO", logo: "assets/agency-logos/kcata.svg" },
    "Kern Regional Transit": { short: "KRT", name: "Kern Regional Transit", color: "#005eb8", location: "Bakersfield, CA", logo: "assets/agency-logos/kern-regional-transit.jpg" },
    ...
    "Kitsap Transit": { short: "KT", name: "Kitsap Transit", color: "#005eb8", location: "Bremerton, WA", logo: "assets/agency-logos/kitsap-transit-official.png" },
    "LA Metro": { short: "LA", name: "Los Angeles Metro", color: "#d11f3d", location: "Los Angeles, CA", logo: "assets/agency-logos/la-metro.svg" },
    "LADOT": { short: "LADOT", name: "Los Angeles Department of Transportation", color: "#005eb8", location: "Los Angeles, CA", logo: "assets/agency-logos/ladot.png" },
    "LYNX": { short: "LYNX", name: "LYNX", color: "#6f2c91", location: "Orlando, FL", logo: "assets/agency-logos/lynx.png" },
    "Long Beach Transit": { short: "LBT", name: "Long Beach Transit", color: "#005eb8", location: "Long Beach, CA", logo: "assets/agency-logos/long-beach-transit.png" },
    "MARTA": { short: "MARTA", name: "Metropolitan Atlanta Rapid Transit Authority", color: "#1c4f9c", location: "Atlanta, GA", logo: "assets/agency-logos/marta.svg" },
    ...
    "Miami-Dade DTPW": { short: "DTPW", name: "Miami-Dade Department of Transportation and Public Works", color: "#f58220", location: "Miami, FL", logo: "assets/agency-logos/miami-dade-dtpw.svg" },
    ...
    "Metro Transit Madison": { short: "Metro", name: "Metro Transit Madison", color: "#0072bc", location: "Madison, WI", logo: "assets/agency-logos/metro-transit-madison.svg" },
    ...
    "Montebello Bus Lines": { short: "MBL", name: "Montebello Bus Lines", color: "#005eb8", location: "Montebello, CA", logo: "assets/agency-logos/montebello-bus-lines.png" },
    "Monterey-Salinas Transit": { short: "MST", name: "Monterey-Salinas Transit", color: "#005eb8", location: "Monterey, CA", logo: "assets/agency-logos/monterey-salinas-transit.png" },
    "Marin Transit": { short: "Marin", name: "Marin Transit", color: "#007a53", location: "San Rafael, CA", logo: "assets/agency-logos/marin-transit.svg" },
    "MTC": { short: "MTC", name: "Metropolitan Transportation Commission", color: "#005eb8", location: "San Francisco, CA", logo: "assets/agency-logos/mtc.svg" },
    ...
    "Napa Valley Transportation Authority": { short: "NVTA", name: "Napa Valley Transportation Authority", color: "#005eb8", location: "Napa, CA", logo: "assets/agency-logos/napa-valley-transportation-authority.png" },
    ...
    "North County Transit District": { short: "NCTD", name: "North County Transit District", color: "#005eb8", location: "Oceanside, CA", logo: "assets/agency-logos/north-county-transit-district.jpg" },
    "Norwalk Transit": { short: "NTS", name: "Norwalk Transit", color: "#005eb8", location: "Norwalk, CA", logo: "assets/agency-logos/norwalk-transit.svg" },
    ...
    "SMART": { short: "SMART", name: "Suburban Mobility Authority for Regional Transportation", color: "#005eb8", location: "Detroit, MI", logo: "assets/agency-logos/smart.svg" },
    ...
    "SamTrans": { short: "SamTrans", name: "San Mateo County Transit District", color: "#005eb8", location: "San Carlos, CA", logo: "assets/agency-logos/samtrans.svg" },
    "San Joaquin RTD": { short: "RTD", name: "San Joaquin Regional Transit District", color: "#005eb8", location: "Stockton, CA", logo: "assets/agency-logos/san-joaquin-rtd.png" },
    "Santa Barbara MTD": { short: "SBMTD", name: "Santa Barbara Metropolitan Transit District", color: "#005eb8", location: "Santa Barbara, CA", logo: "assets/agency-logos/santa-barbara-mtd.png" },
    "Santa Clarita Transit": { short: "SCT", name: "Santa Clarita Transit", color: "#005eb8", location: "Santa Clarita, CA", logo: "assets/agency-logos/santa-clarita-transit.svg" },
    "Santa Cruz METRO": { short: "METRO", name: "Santa Cruz METRO", color: "#005eb8", location: "Santa Cruz, CA", logo: "assets/agency-logos/santa-cruz-metro.png" },
    "San Diego MTS": { short: "MTS", name: "San Diego Metropolitan Transit System", color: "#005eb8", location: "San Diego, CA", logo: "assets/agency-logos/san-diego-mts.svg" },
    "SANDAG": { short: "SANDAG", name: "San Diego Association of Governments", color: "#005eb8", location: "San Diego, CA", logo: "assets/agency-logos/sandag.png" },
    "Santa Maria Regional Transit": { short: "SMRT", name: "Santa Maria Regional Transit", color: "#005eb8", location: "Santa Maria, CA", logo: "assets/agency-logos/santa-maria-regional-transit.svg" },
    "Sonoma County Transit": { short: "Sonoma", name: "Sonoma County Transit", color: "#005eb8", location: "Santa Rosa, CA", logo: "assets/agency-logos/sonoma-county-transit.png" },
    ...
    "Torrance Transit": { short: "TTS", name: "Torrance Transit", color: "#005eb8", location: "Torrance, CA", logo: "assets/agency-logos/torrance-transit.png" },
    "Tulare County Regional Transit Agency": { short: "TCRTA", name: "Tulare County Regional Transit Agency", color: "#005eb8", location: "Visalia, CA", logo: "assets/agency-logos/tulare-county-regional-transit-agency.png" },
    ...
    "VCTC": { short: "VCTC", name: "Ventura County Transportation Commission", color: "#005eb8", location: "Camarillo, CA", logo: "assets/agency-logos/vctc.png" },
    "Visalia Transit": { short: "VT", name: "Visalia Transit", color: "#005eb8", location: "Visalia, CA", logo: "assets/agency-logos/visalia-transit.png" },
    ...
    "WestCAT": { short: "WestCAT", name: "Western Contra Costa Transit Authority", color: "#005eb8", location: "Pinole, CA", logo: "assets/agency-logos/westcat.png" },
